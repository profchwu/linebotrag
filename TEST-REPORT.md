...
網站已發布至 https://profchwu.github.io/linebotrag/ ，首次發布雲端測試通過，範本下載與本機檔案相符。新增關鍵詞 HTML 編碼、CSV 公式前綴保護、步驟二 API 結果刷新，以及 GitHub 未配置後端時的發送阻擋回歸測試，全部通過。實際雲端整合的限制仍如上。風險檢查與免責請見 SECURITY.md 及 README。
